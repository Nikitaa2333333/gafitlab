...
export const SUBCATEGORIES: Subcategory[] = [
  ...
  // centrifuge
  { id: 'products', categoryId: 'centrifuge', name: 'Общий раздел' },
  ...
  { id: 'mini-centrifuge', categoryId: 'centrifuge', name: 'Микроцентрифуги (Mini)' },
  { id: 'prp--cgf-stem-cell-centrifuge', categoryId: 'centrifuge', name: 'PRP /CGF/Stem Cell центрифуги' },
  ...
  { id: 'cyto-smear-liquid-centrifuge', categoryId: 'centrifuge', name: 'Цитоцентрифуги' },
  ...
  { id: 'centrifuge-rotor', categoryId: 'centrifuge', name: 'Роторы (Центрифуги)' },
  ...
  { id: 'swing-rotor', categoryId: 'centrifuge', name: 'Bfket-роторы' },
